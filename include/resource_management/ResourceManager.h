...
protected:
    ...
    virtual CoordinationHeader_t headerFromMsg(const typename CoordinationSignalType::Request &msg) = 0;
    ...
    this->_coordinationSignalService =
            std::make_shared<CoordinationSignals<CoordinationSignalType>>
                                          (
                                              ...
                                              boost::bind(&ResourceManager<CoordinationSignalType,InputDataTypes...>::headerFromMsg,this,_1),
